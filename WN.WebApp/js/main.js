...
/*----------------------------------------------------*/
//* Added by William April 02, 2015.
//* Coordinates (Lat & Long) came from http://www.mapseasy.com/adress-to-gps-coordinates.php 
/*----------------------------------------------------*/
(function () {
    "use strict";
    function initialize() {
      var myLatlng = new google.maps.LatLng(10.8454720,106.6508252),
      mapOptions = {
        zoom: 16,
        center: myLatlng
      },
       map = new google.maps.Map(document.getElementById('map'), mapOptions),
       contentString =  '<strong>SHOP-HT</strong><br>'+
                            'Số 38, Đường số 3, Phường 9, Q.Gò Vấp<br>'+
                            'TP.Hồ Chính Minh<br>',
