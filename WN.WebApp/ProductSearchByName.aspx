<%@ Page Title="" Language="C#" MasterPageFile="~/ShopHTMaster.Master" AutoEventWireup="true" CodeBehind="ProductSearchByName.aspx.cs" Inherits="WN.WebApp.ProductSearchByName" %>
...
<asp:Content ID="contentProductSearchByName" ContentPlaceHolderID="masterPageContentPlaceHolder" runat="server">
    <section id="content">
        <div class="sm-margin">
        </div>
        <div class="row">
