<%@ Page Title="" Language="C#" MasterPageFile="~/ShopHTMaster.Master" AutoEventWireup="true"
    CodeBehind="ProductByCategoryLevel2.aspx.cs" Inherits="WN.WebApp.ProductByCategoryLevel2" %>
...
<asp:Content ID="contentProductByCategoryLevel2" ContentPlaceHolderID="masterPageContentPlaceHolder"
    runat="server">
    <section id="content">
        <div class="sm-margin">
        </div>
